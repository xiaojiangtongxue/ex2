...
/**
 * UserController 是一个基于注解的控制器 可以同时处理多个请求动作
 */
@Controller
public class UserController {
	...
	public String Register(@Valid@ModelAttribute("form") User user, Model model,Errors errors) { // user:视图层传给控制层的表单对象；model：控制层返回给视图层的对象
